...
test("Testing Pagination functionality", ()=> {
    ...
    expect(getByText(currentPage.toString()).parentElement).toHaveClass("page-item active");
    // checking if pages are calculated correctly
    expect(pagenumbersNodes.length).toEqual(Math.ceil(totalImages/imagesPerPage));
